...
// console.log(textoHeading.textContent);

// textoHeading.innerHTML = 'Nuevo Heading';

textoHeading.textContent = 'Clase del DOM de JavaScript'; // También se puede utilizar .text
